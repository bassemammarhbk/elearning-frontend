    ...
    <div className="cours-detail-layout">
            ...
            <li
              ...
              onClick={() => {
                if (!allChaptersCompleted) {
                  toast.error("Vous devez d’abord terminer tous les chapitres du cours pour de passer le test");
      ...
      <main className="cours-content">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          <p style={{ margin: 0 }}>
            <strong>Niveau :</strong> {cours.niveau} | <strong>Durée :</strong> {cours.duree} heures
          </p>
        ...
        {selectedContent ? (
          <div className="selected-content mt-4">
            ...
            <p><strong>Durée :</strong> {selectedContent.duree} minutes</p>
